...
// Xóa các biến session nếu người dùng quay lại form
if ($_SERVER["REQUEST_METHOD"] != "POST") {
    unset($_SESSION['user']); // Xóa session để nhập lại thông tin
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Nếu không có lỗi, lưu thông tin vào session và hiển thị kết quả
    if (empty($errors)) {
        $_SESSION['user'] = [
